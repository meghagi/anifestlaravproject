   ...
   <div class="popup__wrapper">
    ...
    <div class="table-responsive" style="width:1000px;">
        <table class="table table-striped table-bordered yajra_datatable" id="mytable" style="text-align:center; border-color:white; background-color:white;">
            <thead>
                <tr align="center">
                    <th style="color:black;" data-sortable="true">ticketid </th>
                    <th style="color:black;" data-sortable="true">eventid </th>
                    <th style="color:black;" data-sortable="true">cost</th>
                   
                    <th style="color:black;" data-sortable="true">Quantity</th>
                    <th style="color:black;" data-sortable="true">type</th>
                    
                    <th style="color:black;" data-sortable="true">startDate</th>
                    <th style="color:black;" data-sortable="true">endDate</th>
                   
                 
                    <th style="color:black;" data-sortable="true">Action</th>
            </thead>
            <tbody>
            @foreach($data as $totalticket)
                <tr>
                  <td>{{$totalticket->ticketid}}</td>
                  <td>{{$totalticket->eventid}}</td>
                  <td>{{$totalticket->cost}}</td>
                  <td>{{$totalticket->Quantity}}</td>
                 
                  <td>{{$totalticket->type}}</td>
                 
                  
               
                  <td>{{$totalticket->startDate}}</td>
                  <td>{{$totalticket->endDate}}</td>
                  ...
                  <td>
              <a >
              <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#total_ticket" id="Create Total ticket">Add</button>
...
<div class="modal fade" id="total_ticket" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ url('/save-ticket') }}" method="POST" enctype="multipart/form-data" name="myforms1" id="f">
                    @csrf 
      <div class="modal-body">
        ...<div class="form-group">
                        <label for="Ticketid">Ticketid</label>
                        <input type="text" name="ticketid " placeholder="Enter the ticketid "  class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="Bio">eventid </label>
                        <input type="text" name="eventid " placeholder="Enter the eventid " class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="cost">cost</label>
                        <input type="text" name="cost" placeholder="Enter the cost" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="type">
                        ...
                        <input type="text" name="type" placeholder="Enter the type" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="startDate">startDate</label>
                        <input type="text" name="startDate" placeholder="Enter the startDate" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="endDate">endDaten</label>
                        <input type="textarea" name="endDate" placeholder="Enter the endDate" class="form-control">
                    </div>
