 ...
 <div class="offcanvas__search mb-25">
   ...
   <div class="page__full-wrapper">
      ...
      <div class="breadcrumb__menu">
                        <nav>
                           <ul>
                             <li><span><a href="{{url('/dashboard')}}">Home</a></span></li>
                  ...
                  <div class="calendar__wrapper">
                     <div class="calendar__header p-relative">
                        ...
                        <div class="calendar__navigation">
                           <span id="prev" class="calendar__button prev"><i
                                 class="fa-regular fa-arrow-left"></i></span>
                           <span id="next" class="calendar__button next"><i
                        ...
                        <div class="card__title-inner">
                           <div class="card__header-icon">
                              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                 <g clip-path="url(#clip0_209_757)">
                                    <path d="M9.1665 22C7.27185 22 5.729 20.4582 5.729 18.5625C5.729 18.183 6.037 17.875 6.4165 17.875C6.79601 17.875 7.104 18.183 7.104 18.5625C7.104 19.7002 8.02985 20.625 9.1665 20.625C10.3032 20.625 11.229 19.7002 11.229 18.5625C11.229 18.183 11.537 17.875 11.9165 17.875C12.296 17.875 12.604 18.183 12.604 18.5625C12.604 20.4582 11.0613 22 9.1665 22Z" fill="#7A7A7A"></path>
                                    <path d="M16.7291 19.2499H1.60411C0.719559 19.2499 0 18.5304 0 17.6458C0 17.1764 0.204437 16.7319 0.560944 16.4266C0.583939 16.4065 0.608612 16.3882 0.634293 16.3715C1.97992 15.1973 2.75 13.5079 2.75 11.724V9.16655C2.75 6.18106 4.77306 3.61805 7.66975 2.93323C8.04002 2.84797 8.41046 3.07439 8.49757 3.44483C8.58452 3.81426 8.35541 4.18453 7.98698 4.27164C5.71266 4.80875 4.125 6.82174 4.125 9.16655V11.724C4.125 13.9388 3.15417 16.0343 1.46396 17.4724C1.4502 17.4835 1.43828 17.4936 1.42351 17.5037C1.39883 17.5349 1.375 17.5826 1.375 17.6458C1.375 17.7704 1.47957 17.8749 1.60411 17.8749H16.7291C16.8538 17.8749 16.9584 17.7704 16.9584 17.6458C16.9584 17.5815 16.9346 17.5349 16.9089 17.5037C16.8951 17.4936 16.8822 17.4835 16.8694 17.4724C16.0482 16.7722 15.3999 15.9271 14.9436 14.9599C14.7804 14.617 14.9269 14.2073 15.2707 14.0442C15.6173 13.881 16.0233 14.0296 16.1856 14.3723C16.5485 15.1387 17.0573 15.8116 17.7008 16.3744C17.7246 16.3908 17.7495 16.4083 17.7704 16.4266C18.129 16.7319 18.3334 17.1764 18.3334 17.6458C18.3334 18.5304 17.6138 19.2499 16.7291 19.2499Z" fill="#7A7A7A"></path>
                                    <path d="M16.0417 11.9166C12.7565 11.9166 10.0835 9.24365 10.0835 5.95839C10.0835 2.67296 12.7565 0 16.0417 0C19.3271 0 22.0001 2.67296 22.0001 5.95839C22.0001 9.24365 19.3271 11.9166 16.0417 11.9166ZM16.0417 1.375C13.5145 1.375 11.4585 3.43112 11.4585 5.95839C11.4585 8.48566 13.5145 10.5416 16.0417 10.5416C18.569 10.5416 20.6251 8.48566 20.6251 5.95839C20.6251 3.43112 18.569 1.375 16.0417 1.375Z" fill="#7A7A7A"></path>
                                    <path d="M16.2709 8.70828C15.8914 8.70828 15.5834 8.40028 15.5834 8.02078V5.0415H15.125C14.7455 5.0415 14.4375 4.73351 14.4375 4.354C14.4375 3.9745 14.7455 3.6665 15.125 3.6665H16.2709C16.6504 3.6665 16.9584 3.9745 16.9584 4.354V8.02078C16.9584 8.40028 16.6504 8.70828 16.2709 8.70828Z" fill="#7A7A7A"></path>
                                 </g>
                                 <defs>
                                    <clipPath id="clip0_209_75xZXz7">
               ...
               <div class="card__wrapper">
                  <div class="card__header">
                     <div class="card__header-top mb-30">
                        ...
                        <div class="card__header-right">
                           <div class="card__btn">
                              <a href="speaker-list.html">view all Speaker</a>
                           </div>
                           <div class="card__header-dropdown">
                              <div class="dropdown">
                                 <button>
                                 ...
                                 <div class="speaker__info">
                                    <div class="speaker__thumb">
                                       <a href="event-details.html">
                                          <img src="assets/img/speaker/meta/01.png" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="speaker__content">
                                       <h5 class="speaker__title"><a href="event-details.html">Harry Porter</a></h5>
                                       <span class="speaker__status">Digital Marketer</span>
                                    </div>
                                 </div>
                                 <div class="speaker__button">
                                    <a href="event-details.html"><i class="fa-regular fa-angle-right"></i></a>
                                 </div>
                              </div>
                           </div>
                           <div class="speaker__item">
                              <div class="speaker__inner">
                                 <div class="speaker__info">
                                    <div class="speaker__thumb">
                                       <a href="event-details.html">
                                          <img src="assets/img/speaker/meta/02.png" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="speaker__content">
                                       <h5 class="speaker__title"><a href="event-details.html">Alex Don Smith</a></h5>
                                       <span class="speaker__status">Creative Director</span>
                                    </div>
                                 </div>
                                 <div class="speaker__button">
                                    <a href="event-details.html"><i class="fa-regular fa-angle-right"></i></a>
                           ...
                           <div class="speaker__item">
                              <div class="speaker__inner">
                                 <div class="speaker__info">
                                    <div class="speaker__thumb">
                                       <a href="event-details.html">
                                          <img src="assets/img/speaker/meta/03.png" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="speaker__content">
                                       <h5 class="speaker__title"><a href="event-details.html">Lilyen Demi</a></h5>
                                       <span class="speaker__status">Lilyen Demi</span>
                                    </div>
                                 </div>
                                 <div class="speaker__button">
                                    <a href="event-details.html"><i class="fa-regular fa-angle-right"></i></a>
                           ...
                           <div class="speaker__item">
                              <div class="speaker__inner">
                                 <div class="speaker__info">
                                    <div class="speaker__thumb">
                                       <a href="event-details.html">
                                       <img src="assets/img/speaker/meta/04.png" alt="image not found">
                                       </a>
                                    </div>
                                    <div class="speaker__content">
                                       <h5 class="speaker__title"><a href="event-details.html">Lilyen Demi</a></h5>
                        ...
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="assets/img/user/1/01.png" alt="image not found">
                                    </div>
                              ...
                              <td>
                                 <div class="attendant__seminer">
                                    <span><a href="event-details.html">Digital Product Design Seminar - 2023</a></span>
                                 </div>
                              </td>
                              <td>
                              ...
                              <td>
                                 <div class="attendant__action">
                                    <div class="card__header-dropdown">
                                       <div class="dropdown">
                                          <button>
                                             <svg class="dropdown__svg" width="14" height="4" viewBox="0 0 14 4"
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="assets/img/user/1/02.png" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                                       <span>Lary go</span>
                                    </div>
                              ...
                              <td>
                                 <div class="attendant__seminer">
                                    <span class="status"><a href="event-details.html">Graphic Design Innovation Seminar- 2023</a></span>
                                 </div>
                              </td>
                              <td>
                                 <div class="attendant__time">
                              ...
                              <td>
                                 <div class="attendant__status">
                                    <span class="status__tag warning-bg">Pending </span>
                                 </div>
                              </td>
                              <td>
                                 <div class="attendant__action">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="assets/img/user/1/03.png" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                              ...
                              <td>
                                 <div class="attendant__status">
                                    <span class="status__tag teal-bg">Paid</span>
                                 </div>
                              </td>
                              <td>
                                 <div class="attendant__action">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="assets/img/user/1/04.png" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                              ...
                              <td>
                                 <div class="attendant__status">
                                    <span class="status__tag bg-warn">Unpaid</span>
                                 </div>
                              </td>
                              <td>
                                 <div class="attendant__action">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="assets/img/user/1/05.png" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="attendant__user-item">
                                    <div class="registration__user-thumb">
                                       <img src="assets/img/user/1/06.png" alt="image not found">
                                    </div>
                                    <div class="attendant__user-title">
                              ...
                              <td>
                                 <div class="attendant__seminer">
                                    <span><a href="event-details.html">Product & Interaction Seminar - 2023</a></span>
                                 </div>
                              </td>
                              <td>
                                 <div class="attendant__time">
                     ...
                     <div class="scroll-w-4 card__scroll">
                        <div class="card__inner">
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="event-details.html"><img src="assets/img/blog/meta/01.png" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="event-details.html">Digital Business Summit - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
                           ...
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="event-details.html"><img src="assets/img/blog/meta/02.png" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="event-details.html">NASA Space Apps Challenge Summit - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
                           ...
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="event-details.html"><img src="assets/img/blog/meta/03.png" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="event-details.html">Digital Product Design & Interaction Seminar - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
                           ...
                           <div class="news__item">
                              <div class="news__item-inner">
                                 ...
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="{{url('event-details')}}">NASA Space Apps Challenge Summit - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
                           ...
                           <div class="news__item">
                              <div class="news__item-inner">
                                 <div class="news__thumb">
                                    <a href="event-details.html"><img src="{{url('assets/img/blog/meta/03.png')}}" alt="image not found"></a>
                                 </div>
                                 <div class="news__content">
                                    <h4 class="news__title"><a href="{{url('event-details')}}">Digital Product Design & Interaction Seminar - 2023</a></h4>
                                    <div class="news__meta">
                                       <div class="news__meta-status">
                                          <span><i class="flaticon-user"></i></span>
                                          <span>Andru Hebo</span>
