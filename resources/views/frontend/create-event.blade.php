...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/create-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:11 GMT -->
<head>
      <meta charset="utf-8">
                        ...
                        <div class="event__right-box">
                           <div class="create__input-wrapper">
                              <form action="#">
                                 ...
                                 <button type="submit" class="unfield__input-btn w-100 mb-20"><i class="fa-regular fa-plus"></i>Add More Speaker</button>
                                 <button class="input__btn w-100" type="submit">Create Event</button>
                              </form>
                           </div>
                        </div>
                     </div>
...
<!-- Mirrored from codeskdhaka.com/html/expovent-prev/expovent/create-event.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 06:54:12 GMT -->
</html>
