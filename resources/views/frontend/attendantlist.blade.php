               ...
               <div class="breadcrumb__wrapper mb-35">
                  <div class="breadcrumb__main">
                        ...
                        <div class="breadcrumb__menu">
                           <nav>
                              <ul>
                                 ...
                                 <li class="active"><span>Attendant List</span></li>
                              </ul>
                           </nav>
                        </div>
                     </div>
                     ...
                     <div class="breadcrum__button">
                        <a class="breadcrum__btn event__popup-active" href="#">Add New Attendy<i class="fa-regular fa-plus"></i></a>
                     </div>
                  </div>
               </div>
            </div>
                              ...
                              <table>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <div class="attendant__seminer">
                                             <span><a href="event-details.html">Graphic Design Innovation Seminar- 2023</a></span>
                                          </div>
                                       </td>
                                       <td>
                                          <div class="attendant__time">
