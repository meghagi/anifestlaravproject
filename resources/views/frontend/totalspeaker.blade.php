   ...
   <div class="popup__wrapper">
         ...
         <div class="sidebar__inner simple-bar">
            <div class="dlabnav">
               <ul class="metismenu" id="menu">
                  ...
                  <li><a href="{{url('/total-registration')}}" aria-expanded="false">
                        <i class="flaticon-speaker"></i>
                        <span class="nav-text">Total Registration</span>
                     </a>
                  </li>
                  <li><a href="{{url('/total-speaker')}}" aria-expanded="false">
                        <i class="flaticon-speaker"></i>
                        <span class="nav-text">Total Speakers</span>
                     </a>
                  </li>
                  <li><a href="{{url('/newevents')}}" aria-expanded="false">
                        <i class="flaticon-user-1"></i>
                        <span class="nav-text">New Events</span>
                     </a>
                  </li>
                  <li><a href="{{url('/total-ticket')}}" aria-expanded="false">
                        <i class="flaticon-user-1"></i>
                     <span class="nav-text">Total Ticket Sold</span>
                  </a>
                  <!-- <ul aria-expanded="false">
                  ...
                  <li><a href="{{url('/web-traffic')}}" aria-expanded="false">
                        <i class="flaticon-map-2"></i>
                        <span class="nav-text">Web traffic</span>
                     </a>
                  </li>
                  <li><a href="{{url('/schedule-events')}}" aria-expanded="false">
                        <i class="flaticon-map-2"></i>
                        <span class="nav-text">Schedular Events</span>
                     </a>
                  </li>
                  <!-- <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false">
                     <i class="flaticon-user-1"></i>
                     <span class="nav-text">Schedule events</span>
                  </a> -->
                  <!-- <ul aria-expanded="false">
      ...
      <!-- App header area end -->
        ...
        ?> -->
                                          ...
                                          <div class="container">
        <h6 style="text-align: center; background-color: rgb(255, 125, 255, 125); color:white; margin-left:200px;">Total Speaker data Table</h6>
    </div>
    <!-- <a >
                 <button class="btn btn-primary">ADD</button>
              </a> -->
    <div class="table-responsive" style="width:1000px;">
        <table class="table table-striped table-bordered yajra_datatable" id="mytable" style="text-align:center; border-color:white; background-color:white;">
            <thead>
                <tr align="center">
                    <th style="color:black;" data-sortable="true">id</th>
                    <th style="color:black;" data-sortable="true">Name</th>
                    <th style="color:black;" data-sortable="true">bio</th>
                   
                    <th style="color:black;" data-sortable="true">email</th>
                    <th style="color:black;" data-sortable="true">adderess</th>
                    <th style="color:black;" data-sortable="true">city</th>
                    <th style="color:black;" data-sortable="true">phone</th>
                    <th style="color:black;" data-sortable="true">description</th>
                    <th style="color:black;" data-sortable="true">sessiontype</th>
                    
                    <th style="color:black;" data-sortable="true">sessiontitle</th>
                    
                    <th style="color:black;" data-sortable="true">eventid </th>
                    <th style="color:black;" data-sortable="true">image </th>
                    
                 
                    <th style="color:black;" data-sortable="true">Action</th>
            </thead>
            <tbody>
            @foreach($data as $speaker)
                <tr>
                  ...
                  <td>{{$speaker->bio}}</td>
                  <td>{{$speaker->email}}</td>
                  <td>{{$speaker->adderess}}</td>
                  <td>{{$speaker->city}}</td>
                  <td>{{$speaker->phone}}</td>
                  <td>{{$speaker->description}}</td>
                  <td>{{$speaker->sessiontype}}</td>
                  <td>{{$speaker->sessiontitle}}</td>
                  <td>{{$speaker->eventid}}</td>
                  <td>{{$speaker->image}}</td>
                  ...
                  <td>
              <a >
              <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#add_event_modal" id="Create Add Event">Add</button>
...
<div class="modal fade" id="add_event_modal"  role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- <form action="{{ url('/save-speaker') }}" method="POST" enctype="multipart/form-data" name="myforms1" id="f">
                    @csrf  -->
      <div class="modal-body">
      <form action="{{ url('/save-speaker') }}" method="POST"  name="myforms1" id="f">
                    @csrf  
         <!-- ...<div class="form-group">
                        <label for="EventName">Event Name</label>
                        <input type="text" name="EventName" placeholder="Enter the Event Name"  class="form-control">
                    </div> -->
                    <div class="tab-content" id="add_event">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="EventName"><b>EventName<span class="text-danger">
                                                                *</span></b></label>
                                                    <input name="EventName" type="text" id="EventName" class="form-control"
                                                        placeholder="Enter EventName" required/>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="Bio"><b>Bio<span class="text-danger">
                                                                *</span></b></label>
                                                    <textarea type="text" class="form-control" name="edescription" id="Bio" placeholder="Enter event Bio"
                                                        rows="5"></textarea>
                                                </div>
                                            </div>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="text" name="Bio" placeholder="Enter the Bio" class="form-control">
                    </div> -->
                    <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="email"><b>email<span class="text-danger">
                                                                *</span></b></label>
                                                    <input name="email" type="text" id="email"placeholder="Enter the Email"
                    ...
                    <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="Adderess"><b>Adderess<span class="text-danger">
                                                                *</span></b><span data-bs-toggle="tooltip"
                                                                data-bs-placement="top"
                                                                title="Enter Adderess"
                                                                class="text-danger">(?)</span></label>
                                                    <input type="text" name="Adderess" id="Adderess"
                                                        placeholder="Enter key Adderess" class="form-control"
                                                        required/>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="City"><b>City<span class="text-danger">
                                                                *</span></b></label>
                    ...
                    <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="Phone"><b>Phone<span class="text-danger">
                                                                *</span></b></label>
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="text" name="phone" placeholder="Enter the Phone" class="form-control">
                    </div> -->
                    ...
                    <!-- <div class="form-group">
                        ...
                        <input type="textarea" name="description" placeholder="Enter the Description" class="form-control">
                    </div> -->
                    <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="sessiontype"><b>sessiontype<span class="text-danger">
                                                                *</span></b></label>
                                                    <input name="sessiontype" type="text" id="sessiontype" class="form-control"
                                                        placeholder="Enter sessiontype" required>
                                                </div>
                                            </div>
                    <!-- <div class="form-group">
                        <label for="sessiontype">Session Type</label>
                        <input type="text" name="sessiontype" placeholder="Enter the Session Type" class="form-control">
                    </div> -->
                    <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <label for="sessiontitle"><b>sessiontitle<span class="text-danger">
                                                                *</span></b></label>
                                                    <input name="sessiontitle" type="text" id="sessiontitle" class="form-control"
                                                        placeholder="Enter sessiontitle" required>
                                                </div>
                                            </div>

                    <!-- <div class="form-group">
                        <label for="sessiontitle">Session Title</label>
                        <input type="text" name="sessiontitle" placeholder="Enter the Session Title" class="form-control">
                    </div> -->
                    <div class="form-group">
                        <label for="file1">Upload</label>
                        <input type="file" name="file1" class="form-control-file"></input>
            </div>
            </form>      
      </div>
    ...
    var table = $('.yajra_datatable').DataTable({
      ...
      processing: true,
        ...
        columns: [
            ...
            { data: 'sessiontitle', name: 'sessiontitle' },
