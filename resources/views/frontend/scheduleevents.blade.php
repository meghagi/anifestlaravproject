         ...
         <div class="sidebar__inner simple-bar">
            <div class="dlabnav">
               <ul class="metismenu" id="menu">
                  ...
                  <li><a href="{{url('/scheduleevents.')}}" aria-expanded="false">
                        <i class="flaticon-map-2"></i>
        ...
        <table class="table table-striped table-bordered yajra_datatable" id="mytable" style="text-align:center; border-color:white; background-color:white;">
            <thead>
                <tr align="center">
                    ...
                    <th style="color:black;" data-sortable="true">EventName</th>
                    <th style="color:black;" data-sortable="true">Dress</th>
                   
                    <th style="color:black;" data-sortable="true">CreationDate</th>
