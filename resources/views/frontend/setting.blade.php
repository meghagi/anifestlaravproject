                     ...
                     <div class="body__card-wrapper mb-20">
                        <div class="card__header-top">
                           <div class="card__title-inner">
                              <h4 class="event__information-title">Account Information</h4>
                           </div>
                        ...
                        <div class="setting__main-wrapper pt-25">
                           <form action="#">
                              <div class="singel__input-field mb-15">
                              ...
                              <div class="singel__input-field mb-15">
                                 <label class="input__field-text">Gendar</label>
                                    <div class="contact__select">
                                       <select>
                              ...
                              <div class="event__input mb-15">
                                 <label class="input__field-text">Language</label>
                                 <div class="contact__select">
                                    <select>
                              ...
                              <div class="input__btn-wrapper">
                                 <button class="unfield__input-btn" type="submit">Profile Reset</button>
                                 <button class="input__btn" type="submit">Profile Update</button>
                              </div>
                           </form>
                        </div>
                     </div>
