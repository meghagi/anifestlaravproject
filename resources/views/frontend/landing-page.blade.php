                        ...
                        <div class="header__navigation d-flex align-items-center justify-content-between">
                           <div class="header__logo">
                              <a href="{{url('/Dashboard')}}">
                                 <img class="logo__white" src="assets/img/logo/logo.svg" alt="logo not found">
                                 <img class="logo__dark" src="assets/img/logo/logo-dark.svg" alt="logo not found">
                              </a>
                           </div>
                           <div class="header__right">
                                 ...
                                 <nav id="mobile-menu">
                                    <ul>
                                       <li class="has-dropdown has-mega-menu">
                                          ...
                                          <ul class="mega-menu">
                                             <li>
                                                <a href="{{url('/landing')}}" data-background="assets/img/index/landing.jpg"></a>
                                             </li>
                                             <li>
                                                <a href="{{url('/Dashboard')}}" data-background="assets/img/index/dashboard.jpg"></a>
                                             </li>
                                             <li>
                                                <a href="{{url('/eventlist')}}" data-background="assets/img/index/event.jpg"></a>
                                             </li>
                                          </ul>
                                       </li>
                                       <li>
                              ...
                              <div class="header__action-inner">
                                 <div class="header__btn d-none d-xl-block">
                                    <a href="{{url('/Dashboard')}}" class="fill__btn">Buy Ticket<i class="fa-regular fa-angle-right"></i></a>
                                 </div>
            ...
            <div class="row align-items-center">
               <div class="col-xxl-6 col-xl-6 col-lg-6">
                  <div class="about__content-wrapper mb-60">
                     ...
                     <a href="{{url('/eventlist')}}" class="fill__btn">Join Now<i class="fa-regular fa-angle-right"></i></a>
                  </div>
               </div>
               <div class="col-xxl-6 col-xl-6 col-lg-6">
         ...
         <div class="container">
            ...
            <div class="swiper blog__slider-active">
               ...
               <div class="swiper-slide">
                  <div class="blog__item mb-30">
                     <div class="blog__thumb w-img">
                        <a href="{{url('/schedulelist')}}">
                           <img src="assets/img/blog/1/03.jpg" alt="image not found">
                        </a>
                     </div>
                     <div class="blog__content">
                        <h3>
                           <a href="url('/schedulelist')}}">How to get started learning JavaScript the right way
                           </a>
                        </h3>
                     </div>
                     <div class="blog__meta">
                     ...
                     <a class="blog__btn" href="{{url('/schedulelist')}}">business</a>
                  </div>
               </div>
               </div>
            </div>
      ...
      <footer>
         <section class="footer__area footer-bg fix p-relative pt-145">
            <div class="footer__shape">
               <img class="footer__shape-1" src="assets/img/shape/footer/footer-1.png" alt="image not found">
               <img class="footer__shape-2" src="assets/img/shape/footer/footer-2.png" alt="image not found">
               <img class="footer__shape-3" src="assets/img/shape/footer/footer-3.png" alt="image not found">
               <img class="footer__shape-4" src="assets/img/shape/footer/footer-4.png" alt="image not found">
            </div>
            <div class="container">
               <div class="row">
                  <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
                     <div class="footer__widget-1 mb-70">
                        <div class="footer__logo mb-30">
                           <img src="assets/img/logo/logo.svg" alt="image bnot found">
                        </div>
                     ...
                     <div class="footer__widget-2 mb-70">
                        ...
                        <div class="footer__link">
                           <ul>
                              ...
                              <li><a href="{{url('/venue')}}">Venue Info</a></li>
