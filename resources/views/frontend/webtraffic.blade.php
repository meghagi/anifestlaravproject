                        ...
                        <div class="body__card-wrapper mb-20">
                           <div class="card__header-top">
                              <div class="card__title-inner">
                                 <h4 class="event__information-title">Web traffic Information</h4>
                              </div>
                                    ...
                                    <div class="profile__left">
                                       <div class="padding__left-inner p-relative">
                                          ...
                                          <div class="profile__thumb mb-45">
                                             <img src="{{url('assets/img/webtraffic/robots.png')}}" alt="image not found">
                                          </div>
                                          <div class="profile__user">
                                             <ul>
                                                <li>
                                                <form method="POST" action="{{route('savewebtraffic')}}">
                                                  @csrf
...
@enderror
                                                ...
                                                <li> -->
                                                   <div class="profile__user-item">
                                                      ...
                                                      <input id="eventname" type="text" placeholder="Enter Companyname"class="form-control @error('eventname') is-invalid @enderror" name="Companyname" required autocomplete="Companyname">
                                                ...
                                                <div class="profile__user-item">
                                                      ...
                                                      <div class="profile__user-info">
                                                      <input id="dress" type="text" placeholder="Enter product"class="form-control @error('dress') is-invalid @enderror" name="Product"  required autocomplete="Product" autofocus>
                                                     <span class="invalid-feedback text-danger" role="alert">
                                                      @error('Product')
                                                     <strong>{{ $message }}</strong>
                                                      @enderror
                                                   ...
                                                   <div class="profile__user-item">
                                                      ...
                                                      <div class="profile__user-info">
                                                      <input id=">Number of Visitor" type="text" placeholder="Number of Visitor"class="form-control @error('Number of Visitor') is-invalid @enderror" name="NumberofVisitor"  required autocomplete="Number of Visitor" autofocus>
                                                     <span class="invalid-feedback text-danger" role="alert">
                                                      @error('NumberofVisitor')
                                                     <strong>{{ $message }}</strong>
                                                      @enderror
                                                      </span>
                                                                                                          </div>
                                                ...
                                                <li>
                                                   <div class="profile__user-item">
                                                      <div class="profile__user-tiitle">
                                                         <span>NumberofVisit:</span>
                                                      </div>
                                                      <div class="profile__user-info">
                                                      <input id="NumberofVisit" type="text" placeholder="Enter NumberofVisit"class="form-control @error('cost') is-invalid @enderror" name="NumberofVisit"  required autocomplete="NumberofVisit" autofocus>
                                                     <span class="invalid-feedback text-danger" role="alert">
                                                      @error('NumberofVisit')
                                                     <strong>{{ $message }}</strong>
                                                      @enderror
                                                ...
                                                <li>
                                                   <div class="profile__user-item">
                                                      ...
                                                      <div class="profile__user-info">
                                                      <input id="Cost" type="text" placeholder="Enter Cost"class="form-control @error('cost') is-invalid @enderror" name="Cost"  required autocomplete="Cost" autofocus>
                                                     <span class="invalid-feedback text-danger" role="alert">
                                                      @error('Cost')
                                                     <strong>{{ $message }}</strong>
                                                      @enderror
                                                ...
                                                <li>
                                                   <div class="profile__user-item">
                                                      ...
                                                      <div class="profile__user-info">
                                                      <input id="Bounce rate" type="text" placeholder="Enter Bounce rate:"class="form-control @error('Bounce rate:') is-invalid @enderror" name="Bouncerate"  required autocomplete="Bounce rate" autofocus>
                                                     <span class="invalid-feedback text-danger" role="alert">
                                                      @error('Bouncerate')
                                                     <strong>{{ $message }}</strong>
                                                      @enderror
                                    ...
                                    <div class="profile__right p-relative">
                                       ...
                                       <div class="profile__about-info">
                                          ...
                                          <div class="profile__text">
                                             <p class="mb-25">Website traffic refers to the volume of users visiting a website. How many people visit a website will depend on the website's purpose, the visitors' own goals, and the way in which they discovered the site. Servers monitor website activity and register whenever a page receives a visitor (known as a 'hit').</p>
                                             <p>For example, Alice decides to log on to her hair salon's website in an attempt to schedule an upcoming appointment. Not only is Alice considered part of the web traffic on the homepage, but also on the scheduling page that she accesses after clicking on the appropriate page link.</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
