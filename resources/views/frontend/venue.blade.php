         ...
         <div class="sidebar__inner simple-bar">
            <div class="dlabnav">
               <ul class="metismenu" id="menu">
                  ...
                  <li><a href="{{url('/schedule')}}" aria-expanded="false">
                        ...
                        <div class="breadcrumb__menu">
                           <nav>
                              ...
                              <li><span><a href="dashboard.html">Home</a></span></li>
                                 <li class="active"><span>Event Venue</span></li>
                              </ul>
                           </nav>
                        </div>
                     </div>
                     ...
                     <div class="event__venue-card mb-20">
                        <div class="event__venue-inner">
                           <div class="event__venue-content">
                              ...
                              <h4 class="event__venue-title">City Complex Hall, USA</h4>
                              <p>2322 Lincoln Street Mountain View City
                                 United States</p>
                           </div>
                           <div class="event__venue-thumb">
                              <a href="#">
                                 <img src="assets/img/venue/venue-01.jpg" alt="image not found">
                              </a>
                              <div class="event__tag-post">
                                 <div class="event__tag-item">
                                    <span><a href="#">Hall 01</a></span>
                                 </div>
                                 <div class="event__tag-item">
                                    <span><a href="#">20 Seat Available</a></span>
                                 </div> 
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="event__venue-card mb-20">
                        <div class="event__venue-inner">
                           <div class="event__venue-content">
                              ...
                              <h4 class="event__venue-title">China Maitre Hall, China</h4>
                              <p>East Valley St.Westford, MA 01886
                                 China, 6583</p>
                           </div>
                           <div class="event__venue-thumb">
                              <a href="#">
                                 <img src="assets/img/venue/venue-02.jpg" alt="image not found">
                              </a>
                              <div class="event__tag-post">
                                 <div class="event__tag-item">
                                    <span><a href="#">Hall 05</a></span>
                                 </div>
                                 <div class="event__tag-item">
                                    <span><a href="#">100 Seat Available</a></span>
                                 </div> 
                              </div>
                           </div>
                        </div>
                     ...
                     <div class="event__venue-card mb-20">
                        <div class="event__venue-inner">
                           <div class="event__venue-content">
                              ...
                              <h4 class="event__venue-title">Sidny Auditirium, Australia</h4>
                              <p>7825 Homestead Dr.Fenton, MI 48430
                                 Sidny, 1036</p>
                           </div>
                           <div class="event__venue-thumb">
                              <a href="#">
                                 <img src="assets/img/venue/venue-03.jpg" alt="image not found">
                              </a>
                              <div class="event__tag-post">
                                 <div class="event__tag-item">
                                    <span><a href="#">Hall 08</a></span>
                                 </div>
                                 <div class="event__tag-item">
                                    <span><a href="#">160 Seat Available</a></span>
                                 </div> 
                              </div>
                           </div>
                        </div>
