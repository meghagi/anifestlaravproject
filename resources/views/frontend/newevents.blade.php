                                    ...
                                    <div class="profile__left">
                                       <div class="padding__left-inner p-relative">
                                          ...
                                          <div class="profile__thumb mb-45">
                                             <img src="{{url('assets/img/event/event-details.jpg')}}" alt="image not found">
                                          </div>
                                          <div class="profile__user">
                                             <ul>
                                                <li>
                                                <form method="POST" action="{{route('neweventsstore')}}">
                                                  @csrf
...
@enderror
                                                ...
                                                <li> -->
                                                   <div class="profile__user-item">
                                                      ...
                                                      <input id="eventname" type="text" placeholder="Enter eventname"class="form-control @error('eventname') is-invalid @enderror" name="eventname" required autocomplete="eventname">
                                                ...
                                                <div class="profile__user-item">
                                                      ...
                                                      <div class="profile__user-info">
                                                      <input id="dress" type="text" placeholder="Enter dress"class="form-control @error('dress') is-invalid @enderror" name="dress"  required autocomplete="dress" autofocus>
                                                     <span class="invalid-feedback text-danger" role="alert">
                                                      @error('dress')
                                                     <strong>{{ $message }}</strong>
                                                      @enderror
                                                   ...
                                                   <div class="profile__user-item">
                                                      ...
                                                      <div class="profile__user-info">
                                                      <input id="creationdate" type="text" placeholder="EnterCreation Date"class="form-control @error('creationdate') is-invalid @enderror" name="creationdate"  required autocomplete="creationdate" autofocus>
                                                     <span class="invalid-feedback text-danger" role="alert">
                                                      @error('creationdate')
                                                     <strong>{{ $message }}</strong>
                                                      @enderror
                                                ...
                                                <li>
                                                   <div class="profile__user-item">
                                                      ...
                                                      <div class="profile__user-info">
                                                      <input id="type" type="text" placeholder="Enter type"class="form-control @error('type') is-invalid @enderror" name="type"  required autocomplete="type" autofocus>
                                                     <span class="invalid-feedback text-danger" role="alert">
                                                      @error('type')
                                                     <strong>{{ $message }}</strong>
                                                      @enderror
