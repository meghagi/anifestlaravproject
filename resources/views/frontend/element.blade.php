            ...
            <div class="elements__area">
               <div class="row">
                  <div class="col-xxl-4 col-xl-6 col-lg-6">
                     <div class="body__card-wrapper mb-30">
                        <div class="card__header-top">
                           <div class="card__title-inner">
                              <h4 class="event__information-title">Input Fild</h4>
                           </div>
                        ...
                        <div class="input__field-wrapper mt-35">
                           <div class="singel__input-field mb-15">
                              <label class="input__field-text">Normal Input Field</label>
                              <input type="text" placeholder="David">
                           </div>
                           <div class="warning__field mb-15">
                              <label class="input__field-text">Error Input Field</label>
                              <span class="input__alert alert-bg-1"><span>Warning:</span> This fild can not be empty</span>
                           </div>
                           <div class="warning__field mb-15">
                              <label class="input__field-text">Warning Input Field</label>
                              <span class="input__alert alert-bg-2"><span>Warning:</span> This fild can not be empty</span>
                           </div>
                           <div class="warning__field mb-15">
                              <label class="input__field-text">Success Input Field</label>
                              <span class="input__alert alert-bg-3"><span>Warning:</span> This fild can not be empty</span>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                     <div class="elements__area">
                        <div class="body__card-wrapper mb-30">
                           <div class="card__header-top">
                              <div class="card__title-inner">
                                 <h4 class="event__information-title">Buttons</h4>
                              </div>
                              <div class="card__header-dropdown">
                                 <div class="dropdown">
                                    <button>
                           ...
                           <div class="butttons__element-wrapper mt-35">
                              <div class="button__grid-wrapper">
                                 <div class="fill__button-inner">
                                    <a class="element__btn red-bg" href="#">Home</a>
                                    <a class="element__btn perple-bg" href="#">Home</a>
                                    <a class="element__btn yellow-bg" href="#">Home</a>
                                    <a class="element__btn pink-bg" href="#">Home</a>
                                    <a class="element__btn blue-bg" href="#">Home</a>
                                    <a class="element__btn green-bg" href="#">Home</a>
                                 </div>
                                 <div class="border__button-inner">
                                    <a class="element__btn border-red" href="#">Home</a>
                                    <a class="element__btn border-perple" href="#">Home</a>
                                    <a class="element__btn border-yellow" href="#">Home</a>
                                    <a class="element__btn border-pink" href="#">Home</a>
                                    <a class="element__btn border-blue" href="#">Home</a>
                                    <a class="element__btn border-green" href="#">Home</a>
                                 </div>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-xxl-4 col-xl-6 col-lg-6 col-md-6">
                     <div class="card__wrapper total__seat-wapper mb-30">
