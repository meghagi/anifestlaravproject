...
<section class="speaker__popup-area">
   <div class="popup__wrapper">
         ...
         <div class="sidebar__inner simple-bar">
            <div class="dlabnav">
               <ul class="metismenu" id="menu">
                  ...
                  <li><a href="{{url('/totalregistration')}}" aria-expanded="false">
    ...
    <div class="container">
        <h6 style="text-align: center; background-color: rgb(255, 125, 255, 125); color:white; margin-left:200px;">Total Registration data Table</h6>
    </div>
        ...
        <table class="table table-striped table-bordered yajra_datatable" id="mytable" style="text-align:center; border-color:white; background-color:white;">
            <thead>
                <tr align="center">
                    ...
                    <th style="color:black;" data-sortable="true">password</th>
                    <th style="color:black;" data-sortable="true">language</th>
                    <th style="color:black;" data-sortable="true">phonenumber</th>
                    <th style="color:black;" data-sortable="true">adderess</th>
                    <th style="color:black;" data-sortable="true">gender</th>
                    
                    
                    <th style="color:black;" data-sortable="true">role</th>
                    <!-- <th style="color:black;">remember_token</th>
                    <th style="color:black;">created_at</th>
                    <th style="color:black;">updated_at</th> -->
                                         ...
                                         {{-- <div class="profile__user">
                                             <ul>
                                                <li>
                                                   ...
                                                   {{--   <!-- <?php
        $crud = \DB::table('users')->where('Role', '!=', 'admin')->get();
        ?>                                           <!-- <span>First Name:</span> -->
                                                      <h5 style="text-align: center;  color: white">Customer View</h1>
                                                       <button class="btn btn-primary d-inline-block m-2 float-right">Add</button>
                                                       @if(Auth::check())
   {{-- <table class="table"style="border-color:white; background-color:white">
        <thead>
            <tr>
                <th>Name</th>
                <th>Email</th>
        ...
        @foreach($customer as $cust)
            <tr>
                ...
                <td>{{$cust->address}}</td> <!-- Corrected 'address' spelling -->
                <td>{{$cust->state}}</td>
                <td>{{$cust->country}}</td>
                <td>{{$cust->DOB}}</td>
                <td>
