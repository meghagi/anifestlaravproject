            ...
            <div class="dlabnav">
               <ul class="metismenu" id="menu">
                  ...
                  <li><a href="{{url('/total-speaker')}}" aria-expanded="false">
                        ...
                        <span class="nav-text">total-speaker</span>
                     </a>
                  </li>
                     ...
                     <div class="body__card-wrapper">
                        <div class="card__header-top bb-0 pb-0">
                           <div class="card__title-inner">
                              <h4 class="event__information-title">Event calender</h4>
                           </div>
                           ...
                           <div class="calendar__wrapper">
                              <div class="calendar__header p-relative">
                                 ...
                                 <div class="calendar__navigation">
                                    <span id="prev" class="calendar__button prev"><i class="fa-regular fa-arrow-left"></i></span>
                                    <span id="next" class="calendar__button next"><i class="fa-regular fa-arrow-right"></i></span>
                                 </div>
                              </div>
                              <div class="calendar">
                              <ul class="weeks">
               ...
               <div class="col-xxl-6 col-xl-6">
                  <div class="body__card-wrapper">
                     <div class="map__wrapper">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d233613.43676479085!2d90.43426044645838!3d23.811132204857916!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sbd!4v1674730159777!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                     </div>
                  </div>
               </div>
            </div>
